														...
														<div class="form-row">
															...
															<div class="form-group col-md-3">
																...
																<select id="city" name="city" class="form-control">
																	...
																	<option value="Khyber Pakhtunkhwa" <?php if ($row['city']=='Khyber Pakhtunkhwa'){echo "selected";}?>>Khyber Pakhtunkhwa</option>
																	<option value="Gilgit" <?php if ($row['city']=='Gilgit'){echo "selected";}?>>Gilgit</option>
																	<option value="Swat" <?php if ($row['city']=='Swat'){echo "selected";}?>>Swat</option>
