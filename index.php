	...
	<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 ml-auto">
						...
						<h4>Address - Progressive Center, suite # 202-203, 30-A Shahrah-e-Faisal Rd, Karachi, 75400</h4>
						<h4>Contact no. - (021) 34385418</h4>
					</div>
					<div class="col-md-6">
						<iframe src="https://www.google.com/maps/d/embed?mid=1O7pQDJTpG7yaIswTcG_FeAlQTsk&hl=en&ehbc=2E312F" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
				</div>
			</div>
		</section>
		<footer>
			<div class="container">
				<div class="row">
					<div class="col">
						<h5>All rights reserved by Aptech Karachi 2022</h5>
					</div>
				</div>
			</div>
		</footer>
